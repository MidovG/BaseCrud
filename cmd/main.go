...
func main() {
	...
	r.HandleFunc("/add_user", createUser)
	r.HandleFunc("/delete/{id}", deleteUserById)
	r.HandleFunc("/update/{id}", editPage).Methods("GET")
	r.HandleFunc("/update/{id}", updateUser).Methods("POST")
